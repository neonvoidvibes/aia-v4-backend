/**
 * Resilient WebSocket client for web browsers
...
class ResilientWebSocket {
    ...
    /**
     * Set up network change detection for automatic reconnection
     */
    setupNetworkChangeDetection() {
        if (typeof window !== 'undefined') {
            ...
            // Connection type changes (if available)
    ...
    handleNetworkRestore() {
        ...
        if (this.connectionState === 'disconnected' && !this.isIntentionalDisconnect) {
            // Immediate reconnection attempt when network is restored
     ...
     */
    handleNetworkLoss() {
        console.log('Network lost, will attempt reconnection when restored');
    ...
    handleConnectionChange() {
        if (navigator.connection && this.connectionState === 'connected') {
            console.log(`Connection changed to ${navigator.connection.effectiveType}`);
            // Connection type changed while connected - test connection health
     ...
     */
    resumeAudioCapture() {
        if (this.isAudioCaptureActive && (!this.mediaRecorder || this.mediaRecorder.state === 'inactive')) {
